...
def ModuleHomepage():
    ...
    #else:
    return render_template("Method_Checker_Homepage.html", LIMSRef=LIMSReferralName(), LocalIPAddress=VIPER_Utility.VIPER_DecodeLoginCookie(request.cookies.get('VIPER_LocalUserInfo'))["LocalIPAddress"] )
