...
def ConstructVIPERModule(RefName,FolderDir=False,FileToTransform=False):
    ...
    HelpfulAdvice = f"""             #WRITE CODE HERE
            ...
            #Output = json.loads( VIPER_Utility.LIMSQuery(request, "sakila", QueryRequest, "fetchall") )                   #example backend SQL request
            #VIPER_Utility.LogOutput(Output, ModuleName(), os.getcwd()+r"\Logs")                                                                 #example log result \n"""
    ...
    ObjectLibrary["ThreeJS"] = """ """#not implemented yet
...
"""
    ...
    PrecedingElementList["ThreeJS"] = """<script async src="https://unpkg.com/es-module-shims@1.8.0/dist/es-module-shims.js"></script><script type="importmap">
  {
    "imports": {
