...
def ModuleHomepage():
    ...
    #else:
    return render_template("BoaConstructorHome_Homepage.html", LIMSRef=LIMSReferralName(), LIMSPreRoute=LIMSPreRoute, LocalIPAddress=VIPER_Utility.VIPER_DecodeLoginCookie(request.cookies.get('VIPER_LocalUserInfo'))["LocalIPAddress"] )
