...
def ModuleHomepage():
    ...
    return render_template("Module_Toggler_Homepage.html", LIMSRef=LIMSReferralName(), VIPERModuleLister=DetectedModuleListHTMLified, LocalIPAddress=VIPER_Utility.VIPER_DecodeLoginCookie(request.cookies.get('VIPER_LocalUserInfo'))["LocalIPAddress"] )
