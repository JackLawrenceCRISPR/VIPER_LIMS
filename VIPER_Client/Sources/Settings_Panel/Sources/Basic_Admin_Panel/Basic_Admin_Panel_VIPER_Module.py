...
def ModuleHomepage():
    ...
    #else:
    return render_template("Basic_Admin_Panel_Homepage.html", LIMSRef=LIMSReferralName(), LocalIPAddress=VIPER_Utility.VIPER_DecodeLoginCookie(request.cookies.get('VIPER_LocalUserInfo'))["LocalIPAddress"] )
